...
export function useSystemRoleManagement() {
    ...
    const permissionItems = ['view', 'create', 'update', 'delete', 'export', 'view_roster', 'remove_student', 'continue_payment', 'view_enrollments', 'delete_enrollment', 'preview_invoice', 'preview_certificate', 'download_certificate', 'detail'] as const
