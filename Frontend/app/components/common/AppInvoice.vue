          ...
          <div class="grid grid-cols-2 text-sm">
            <div class="space-y-1">
              ...
              <div class="grid grid-cols-[80px_1fr] gap-2 pt-2">
                ...
                <span class="font-bold text-slate-900">{{ formatDateShort(selectedReportInvoice?.date || new Date()) }}</span>
                <span class="text-slate-600 font-bold">{{ t('pages.school.invoice.fields.endDate') }}:</span>
                <span class="font-bold text-slate-900">{{ formatDateShort(selectedReportInvoice?.endDate || new Date(Date.now() + 30 * 24 * 60 * 60 * 1000)) }}</span>
