...
class ClassRepository(BaseRepository[SchoolClass]):
    ...
    def list_classes(
        ...
        *,
        ...
        statement = (
            select(SchoolClass, Category.name.label("category_name"), Course.course_name, student_count)
            ...
            .group_by(SchoolClass.id, Category.name, Course.course_name)
        )
        if category_id:
        ...
        data = []
        for school_class, category_name, course_name, count in rows:
            data.append(
                ClassRead(
                    id=school_class.id,
                    ...
                    level_km=school_class.level_km,
