...
def _commission_amount(sale_amount: Decimal) -> Decimal:
    return (sale_amount * DEFAULT_COMMISSION_RATE).quantize(Decimal("0.01"))
...
def record_commission_for_sale(
    ...
    *,
    ...
    commission_amount = _commission_amount(sale_amount)
